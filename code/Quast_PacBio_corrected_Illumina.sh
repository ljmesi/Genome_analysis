...
#SBATCH -n 2
#SBATCH -t 01:00:00
#SBATCH -J quast_PacBio_corrected_Illumina_evaluation
...
-o /home/lame5423/Genome_analysis/analyses/03_genome_assembly/PacBio_corrected_Illumina_evaluation/Quast \
